    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        if (heldItem == null){
            ...
            if (item == ValkyrienSkiesControl.INSTANCE.vsWrench){
                worldIn.setBlockState(pos, BlockInit.BLOCK_PLASMACONTROLLER.getDefaultState().withProperty(FACING, EnumFacing.getDirectionFromEntityLiving(pos, playerIn).getOpposite()));
            }
        }
        return true;
    }
